...
class Settings:
    ...
    def __post_init__(self) -> None:
        ...
        _require_non_negative_int("MYSQL_MAX_OVERFLOW", self.mysql_max_overflow)
        _require_positive_int("MYSQL_POOL_TIMEOUT", self.mysql_pool_timeout)
    ...
    def from_env(cls) -> "Settings":
        ...
        return cls(
            ...
            mysql_pool_recycle_seconds=_get_int("MYSQL_POOL_RECYCLE_SECONDS", 1800),
            mysql_max_overflow=_get_int("MYSQL_MAX_OVERFLOW", 10),
            mysql_pool_timeout=_get_int("MYSQL_POOL_TIMEOUT", 30),
